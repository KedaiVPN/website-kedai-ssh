...
// Get all servers
router.get('/servers', verifyToken, verifyAdmin, (req, res) => {
...
// Add new server
router.post('/servers', verifyToken, verifyAdmin, (req, res) => {
  const {
    domain,
    auth,
    nama_server,
...
// Edit server by ID
router.put('/servers/:id', verifyToken, verifyAdmin, (req, res) => {
  const {
    domain,
    auth,
    nama_server,
...
// Delete server by ID
router.delete('/servers/:id', verifyToken, verifyAdmin, (req, res) => {
